...
تستطيع أن تضيف رابط خارجى مربوط بأى مربع حوار موجود فى الصفحة الخاصة بك عن طريق الكود <code>افتح مربع الحوار اسم_مربع_الحوار_الذى_تريد_فتحه</code> كالمثال.
...
```javascript
إذا نقر على العنصر اسم_العنصر_الذى_سيتم_عليه_الحدث,
	* اجعل الوقت الذى مر من اسم_العنصر إلى 5
```
...
```javascript
إذا نقر على العنصر اسم_العنصر_الذى_سيتم_عليه_الحدث,
	* اجعل الوقت الذى مر من اسم_العنصر لقيمة اسم_العنصر_اللى_هتاخد_القيمة_منه
```
...
```javascript
إذا نقر على العنصر اسم_العنصر_الذى_سيتم_عليه_الحدث,
	* اجعل قيمته قيمة اسم_العنصر_اللى_هتاخد_القيمة_منه
```
...
```javascript
إذا نقر على العنصر اسم_العنصر_الذى_سيتم_عليه_الحدث,
	* اجعل قيمة اسم_العنصر إلى مرحبا بالعالم !
```
...
```javascript
إذا نقر على العنصر اسم_العنصر_الذى_سيتم_عليه_الحدث,
	*  قيمة اسم_العنصر لقيمة اسم_العنصر_اللى_هتاخد_القيمة_منه
```
...
```javascript
إذا نقر على العنصر اسم_العنصر_الذى_سيتم_عليه_الحدث,
	* اجعل العرض الخاص به قيمة اسم_العنصر
```
```javascript
إذا نقر على العنصر اسم_العنصر_الذى_سيتم_عليه_الحدث,
	* اجعل خلفيته لون عشوائى غامق
```
...
تستطيع أن تدخل أى بيانات تريدها فى قاعدة البيانات الخاصة بالبرنامج الخاص بك على Google Firebase كاﻵتى:

#### إدخال بيانات لقاعدة بيانات عامة
```javascript
إذا نقر على العنصر زرار_الإرسال,
	فى حالة أن قيمة نوع_الرسالة تساوى استفسار,
		* اذهب إلى قاعدة البيانات العامة الرسائل الفرع الإستفسارات ثم قم بإدخال البيانات التالية:
			* الاسم: << قيمة العنصر خانة_الاسم >>
			* البريد_الإلكترونى: << قيمة العنصر خانة_البريد_الإلكترونى >>
			* الإستفسار: << قيمة العنصر الرسالة >>
	و إلا فى حالة أن قيمة نوع_الرسالة تساوى شكوى,
		* اذهب إلى قاعدة البيانات العامة الرسائل الفرع الشكاوى ثم قم بإدخال البيانات التالية:
			* الاسم: << قيمة العنصر خانة_الاسم >>
			* البريد_الإلكترونى: << قيمة العنصر خانة_البريد_الإلكترونى >>
			* الشكوى: << قيمة العنصر الرسالة >>
```
...
```javascript
إذا نقر على العنصر اسم_العنصر_الذى_سيتم_عليه_الحدث,
	* اذهب إلى قاعدة البانات الخاصة الهوايات الفرع الرياضة ثم قم بإدخال البيانات التالية:
		* الرياضة1:  << قيمة العنصر مكان_إدخال_الرياضة1 >>
		* الرياضة2:  << قيمة العنصر مكان_إدخال_الرياضة2 >>
```
...
```javascript
إذا نقر على العنصر اسم_العنصر_الذى_سيتم_عليه_الحدث,
	* اذهب إلى قاعدة البيانات العامة مصر الفرع المواطنين ثم قم بإستدعاء قيمة الشريحة العنوان التى عندها نفس نوع قيمة مكان_كتابة_الاسم فى الشريحة الاسم و اجعلها قيمة عنوان_المواطن
```
...
```javascript
إذا نقر على العنصر اسم_العنصر_الذى_سيتم_عليه_الحدث,
	* اذهب إلى قاعدة البيانات الخاصة الهوايات الفرع الرياضة ثم قم بإستدعاء قيمة الشريحة الرياضة2 التى عندها نفس نوع قيمة مكان_إدخال_الرياضة1 فى الشريحة الرياضة1 و اجعلها قيمة الرياضة2
```
...
تستطيع أن تظهر لوحة المفاتيح التى تكون ظاهرة على الشاشة برمجيا باستخدام الأمر: اظهر لوحة المفاتيح

### إخفاء لوحة المفاتيح التى تكون ظاهرة على الشاشة
...
إنك تخفى لوحة المفاتيح التى تكون ظاهرة على الشاشة برمجيا باستخدام الأمر: اخفى لوحة المفاتيح
