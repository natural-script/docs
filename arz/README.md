...
```javascript
لما يضغط على العنصر اسم_العنصر_الذى_هيتم_عليه_الحدث,
	* خلى الوقت اللى عدى من اسم_العنصر لقيمة اسم_العنصر_اللى_هتاخد_القيمة_منه
```
...
```javascript
لما يضغط على العنصر اسم_العنصر_الذى_هيتم_عليه_الحدث,
	*  خلى قيمته قيمة اسم_العنصر_اللى_هتاخد_القيمة_منه
```
...
```javascript
لما يضغط على العنصر اسم_العنصر_الذى_هيتم_عليه_الحدث,
	* خلى قيمة اسم_العنصر إلى مرحبا بالعالم !
```
...
```javascript
لما يضغط على العنصر اسم_العنصر_الذى_هيتم_عليه_الحدث,
	* خلى قيمة اسم_العنصر لقيمة اسم_العنصر_اللى_هتاخد_القيمة_منه
```
...
```javascript
لما يضغط على العنصر اسم_العنصر_الذى_هيتم_عليه_الحدث,
	* خلى العرض بتاعه قيمة اسم_العنصر
```
```javascript
لما يضغط على العنصر اسم_العنصر_الذى_هيتم_عليه_الحدث,
	* خلى خلفيته لون عشوائى غامق
```
...
```javascript
لما يضغط على العنصر اسم_العنصر_الذى_هيتم_عليه_الحدث,
	فى حالة إن قيمة نوع_الرسالة تساوى استفسار,
		* روح لقاعدة البيانات العامة الرسائل الفرع الإستفسارات و بعد كدة دخل البيانات دى:
			* الاسم: << قيمة العنصر خانة_الاسم >>
			* البريد_الإلكترونى: << قيمة العنصر خانة_البريد_الإلكترونى >>
			* الإستفسار: << قيمة العنصر الرسالة >>
	و إلا فى حالة إن قيمة نوع_الرسالة تساوى شكوى,
		* روح لقاعدة البيانات العامة الرسائل الفرع الشكاوى و بعد كدة دخل البيانات دى:
			* الاسم: << قيمة العنصر خانة_الاسم >>
			* البريد_الإلكترونى: << قيمة العنصر خانة_البريد_الإلكترونى >>
...
```javascript
لما يضغط على العنصر اسم_العنصر_الذى_هيتم_عليه_الحدث,
	* روح لقاعدة البانات الخاصة الهوايات الفرع الرياضة و بعد كدة دخل البيانات دى:
...
```javascript
لما يضغط على العنصر اسم_العنصر_الذى_هيتم_عليه_الحدث,
	* روح لقاعدة البيانات العامة مصر الفرع المواطنين و بعد كدة هات قيمة الشريحة العنوان اللى عندها نفس نوع قيمة مكان_كتابة_الاسم فى الشريحة الاسم و خليها قيمة عنوان_المواطن
```
...
```javascript
لما يضغط على العنصر اسم_العنصر_الذى_هيتم_عليه_الحدث,
	* روح لقاعدة البيانات الخاصة الهوايات الفرع الرياضة و بعد كدة هات قيمة الشريحة الرياضة2 اللى عندها نفس نوع قيمة مكان_إدخال_الرياضة1 فى الشريحة الرياضة1 و خليها قيمة الرياضة2
```
